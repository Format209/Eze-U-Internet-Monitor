...
const scenarios = [
  { desc: 'Local Development', protocol: 'http:', hostname: 'localhost', port: '4280' },
  { desc: 'Network Access (Dev)', protocol: 'http:', hostname: '192.168.0.2', port: '4280' },
  { desc: 'Docker/Production', protocol: 'http:', hostname: 'localhost', port: '8745' },
  { desc: 'Network Access (Prod)', protocol: 'http:', hostname: '192.168.0.2', port: '8745' },
...
console.log('it will ALWAYS connect to the backend on the SAME IP/hostname at port 8745.');
console.log('\nThis means:');
